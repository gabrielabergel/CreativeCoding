...
function preload() {
  noteA = loadSound("/sounds/sonA.mp3");
  noteB = loadSound("/sounds/sonB.mp3");
  noteC = loadSound("/sounds/sonC.mp3");
  noteD = loadSound("/sounds/sonD.mp3");
  noteE = loadSound("/sounds/sonE.mp3");
